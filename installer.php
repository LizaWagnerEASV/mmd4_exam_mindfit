...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'mindfitWordPressclone_9fb85122dbdaf4794468_20200520204633_archive.zip';
	const ARCHIVE_SIZE		 = '294253665';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '9fb8512-20204633';
    const SECONDARY_PACKAGE_HASH = '02a4cb4-20204633';
